   ...
   <div className="flex h-[573px]">  
      <div className="bg-midnight-900 w-[230px] ">
         ...
         <div className="h-[230px] mx-3 font-montserrat overflow-auto"> 
            ...
            <button className="w-[200px] text-[14px] my-3 mx-4 p-2.5 rounded-3xl border-secondary bg-midnight-900 border-[1px]
               font-montserrat font-bold">Invite members</button>
      </div>

      <div className="w-full h-[70px]">
      <div className=" flex justify-between items-center mx-9 my-5">
         <input className="px-4 py-2 outline-none rounded-full w-[240px] bg-midnight-900"
               type="text"
               placeholder="Search"
         />
         <div className='flex justify-between items-center w-[200px]'>
            <div className="relative">
               <button className="w-[125px] text-white bg-primary py-2 px-4 rounded-full pl-9 font-bold shadow-lg text-[15px]"
                  >Add new</button>
               <img className="h-[27px] absolute  top-[5px] left-1.5" src={addSymbol}/>   
            </div>
               <img className="rounded-full border-[1px] h-[40px] w-[40px] bg-white" src='' alt='profile'/>
         </div>
      </div>
      </div>
    </div>
